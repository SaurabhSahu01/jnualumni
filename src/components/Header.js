...
function Header() {
  return (
    <div className='bg-neutral-100 flex justify-center self-center w-11/12 mx-auto border-black border-b-2 py-2 sticky top-0 z-50'>
      ...
      <section className='flex-2 justify-center self-center'>
        <ul className='flex justify-center self-center gap-5' id="navbar">
          ...
          <li>
            <input className="btn btn-primary bg-blue-600 rounded-full" type="button" value="Log In"/>
          </li>
        </ul>
      </section>
    </div>
